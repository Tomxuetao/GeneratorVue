...
;(function () {
    var resList = {
        ...
        css: [
            window.SITE_CONFIG.cdnUrl + '/css/app.css'
        ],
        js: [
            // 插件, 放置业务之前加载, 以免业务需求依赖插件时, 还未加载出错
            // 业务
            window.SITE_CONFIG.cdnUrl + '/js/manifest.js',
            window.SITE_CONFIG.cdnUrl + '/js/vendor.js',
            window.SITE_CONFIG.cdnUrl + '/js/app.js'
        ]
    };
